  ...
  return (
    <li
      ...
      style={{
        ...
        gap: 12,
        padding: "14px 18px",
        background: hov ? "rgba(200,169,110,0.06)" : "rgba(255,255,255,0.025)",
    ...
    >
      ...
      <span
        style={{
          ...
          fontWeight: 300,
          lineHeight: 1.55,
          color: hov ? "rgba(255,255,255,0.88)" : "rgba(255,255,255,0.62)",
...
export default function ServicePage({ serviceId, title, items, img, onBack }) {
  ...
  return (
    <div
      style={{
        background:
          "linear-gradient(180deg, #070C18 0%, #0A1020 60%, #0D1428 100%)",
        minHeight: "100vh",
      }}
    >
      {/* ── Hero Banner ── */}
      <div
        style={{
          position: "relative",
          background:
            "linear-gradient(135deg, #0A0F1E 0%, #111928 60%, #0D1525 100%)",
      ...
      >
        ...
        >
            ...
            <div>
              ...
              <h1
                style={{
                  ...
                  margin: 0,
                  opacity: heroInView ? 1 : 0,
                  transform: heroInView ? "none" : "translateY(16px)",
          ...
          <div
            style={{
              ...
              marginTop: 32,
              background:
                "linear-gradient(90deg, #C8A96E, rgba(200,169,110,0.1) 80%, transparent)",
        ...
        <div
          style={{
            ...
            height: 2,
            background:
              "linear-gradient(90deg, transparent, #C8A96E 30%, #E4C47A 50%, #C8A96E 70%, transparent)",
          }}
        />
      </div>
